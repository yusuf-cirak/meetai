		...
		<div className="flex-1 pb-4 px-4 md:px-8 flex flex-col gap-y-4">
			...
			{data.items.length === 0 && (
				<EmptyState
					...
					description="Create an agent to join your meetings. Each agent will follow your instructions and can interact with participants during the call."></EmptyState>
			)}
		</div>
	);
};
...
export const AgentsViewError = () => {
	return (
		<ErrorState
			title="Error when loading agents"
